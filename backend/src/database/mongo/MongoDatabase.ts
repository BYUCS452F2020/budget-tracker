...
export class MongoDatabase implements Database {
    ...
    loginUser(email: string, passwd: string): Promise<User> {
        ...
        return userGetPromise.then((res: any) => {
    ...
    async getCategory(categoryId: string): Promise<Category> {
        let category: any = await CategoryModel.findById(categoryId);
        console.log(`Retrieved ${category} category document.`);
        return {
            category_id: category._id,
            category_name: category.category_name,
            amount: category.amount,
    ...
    async getExpenses(userId: string): Promise<Expense[]> {
        ...
        for (let i = 0; i < balanceCategories.length; i++) {
            let balanceExpenses: Expense[];
            const res: any[] = await ExpenseModel.find({ category: balanceCategories[i].category_id });
    ...
    addUser(newUser: BaseUser): Promise<User> {
        ...
        return userAddPromise.then((res: any) => {
    ...
    editUser(user: User): Promise<User> {
        ...
        return userUpdatePromise.then((res: any) => {
    ...
    deleteUser(userId: string): Promise<void> {
        let userDeletePromise = UserModel.findByIdAndDelete(userId);
        return userDeletePromise.then((res: any) => {
    ...
    async addCategory(newCategory: BaseCategory): Promise<Category> {
        ...
        return categoryAddPromise.then((res: any) => {
    ...
    deleteCategory(categoryId: string): Promise<void> {
        ...
        let categoryDeletePromise = CategoryModel.findByIdAndDelete(categoryId);
        return categoryDeletePromise.then((res: any) => {
    ...
    async addExpense(newExpense: BaseExpense): Promise<Expense> {
        ...
        const user: any = await UserModel.findById(category.user);
    ...
    async editExpense(expense: Expense): Promise<Expense> {
        ...
        let prevCategory: any = await CategoryModel.findById(expenseToUpdate.category);
    ...
    async deleteExpense(expenseId: string): Promise<void> {
        ...
        let category: any = await CategoryModel.findById(expenseToDelete.category);
    ...
    async addIncome(newIncome: BaseIncome): Promise<Income> {
        ...
        const user: any = await UserModel.findById(newIncome.user_id);
        ...
        return incomeAddPromise.then((res: any) => {
    ...
    async deleteIncome(incomeId: string): Promise<void> {
        ...
        let user: any = await UserModel.findById(income.user);
